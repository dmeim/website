...
- Package manager: npm
- Pages: `/` (Home), `/projects`, `/tools` (catalogue + 4 ready tools), `/keys`, `/connect`, `/game-of-life` (landing write-up), `/game-of-life/simulation` (full-page simulator; not in primary nav)
